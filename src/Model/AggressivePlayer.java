...
public class AggressivePlayer extends Player {
    ...
    /*
    * aggressive attack behaviosr choosing the best country's army and attack by maximum armies
    * 
   */
public  ArrayList<Country>  aggressiveAttack()
{
  ...
  for(int i=1;i<playersCountries.size();i++){
    ...
    ArrayList<Country>  adjacentCountries = ConquestController.getInstance().getAdjacentCountries( maxArmyCountry.getAdjacentCountriesID());
